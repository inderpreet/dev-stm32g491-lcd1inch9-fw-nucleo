...
void LCD_1in9_test()
{
    ...
    printf("drawing...\r\n");
    Paint_SetRotate(180);
    Paint_DrawString_EN(10, 10, "Follow @ip_v1", &Font24, YELLOW, RED);
    Paint_DrawString_EN(10, 34, "X, Insta", &Font24, BLUE, CYAN);
    
    // Paint_DrawFloatNum (10, 54, 987.654321,3, &Font12, WHITE, BLACK);
    // Paint_DrawString_CN(10, 130, "΢ѩ����", &Font24CN, WHITE, BLUE);
    
//    Paint_DrawImage(gImage_1, 30, 70, 60, 60);
    Paint_DrawImage(gImage_logo, 30, 70, 100, 100);
